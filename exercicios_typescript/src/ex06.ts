...
interface Veiculo {
  ...
  function atualizarAnoVeiculos(veiculo: Veiculo, novoAno: number): Veiculo {
    // Cria um novo objeto veículo com o ano atualizado
    const veiculoAtualizado: Veiculo = {
      ...veiculo,  // Copia todas as propriedades do veículo existente
      ano: novoAno  // Atualiza a propriedade ano com o novo valor
    };
  ...
  const anoAtualizado: number = 2022;
