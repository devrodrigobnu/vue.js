...
// e pretende implantar a metodologia da tabelinha, que já é um 
...
// a partir do preço do pão informado pelo usuário, conforme o exemplo 
// abaixo:
// Preço do pão: R$ 0.18
...
let precoUnitario = Number(prompt('Digite o preço do pãozinho: '))

for (let quantidade = 1; quantidade <= 50; quantidade++){
    let precoTotal = quantidade * precoUnitario
    console.log(`${quantidade} - R$${precoTotal}`)
}