...
// de R$1,99 com cerca de 10 caixas. Para agilizar o cálculo de 
// quanto cada cliente deve pagar, ele desenvolveu uma tabela que 
// contém o número de itens que o cliente comprou e ao lado o valor 
// da conta. Desta forma a atendente do caixa precisa apenas contar 
...
for (let quantidade = 1; quantidade <= 50; quantidade++){
    ...
    console.log(`${quantidade} - ${precoTotal}`) 
}
